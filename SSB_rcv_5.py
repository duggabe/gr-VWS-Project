...
class SSB_rcv_5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.band_pass_filter_taps = band_pass_filter_taps = firdes.complex_band_pass(1.0, samp_rate, 300, 3500, 100, window.WIN_HAMMING, 6.76)
        ...
        self.connect((self.fft_filter_xxx_0, 0), (self.blocks_complex_to_float_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_band_pass_filter_taps(firdes.complex_band_pass(1.0, self.samp_rate, 300, 3500, 100, window.WIN_HAMMING, 6.76))
