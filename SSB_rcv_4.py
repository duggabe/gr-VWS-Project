...
class SSB_rcv_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB_rcv_4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB_rcv_4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SSB_rcv_4")
...
def main(top_block_cls=SSB_rcv_4, options=None):
